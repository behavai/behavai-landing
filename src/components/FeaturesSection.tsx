...
export function FeaturesSection() {
  ...
  return (
    <section className="relative h-screen snap-start overflow-y-auto bg-white px-6 md:px-12 py-12">
      <div className="flex flex-col gap-4 max-w-7xl mx-auto my-[2rem]">
        {/* Title */}
        <motion.h2
          ref={titleRef}
          ...
          {[
            ...
            >
              ...
              <img
                src={card.image}
                alt={card.title}
                className="h-[40%] object-cover rounded-[16px] mb-4"
              />
              <h3 className="text-lg font-cooper font-semibold text-[#080015] mb-1">
                {card.title}
              </h3>
              <p className="text-sm text-gray-600 font-inter text-center mx-15">{card.desc}</p>
            </motion.div>
          ))}
        </motion.div>

        {/* Checklist + Image */}
        <div className="grid grid-cols-1 md:grid-cols-2 items-center my-[-10rem]">
        {/* Left: Checklist */}
        ...
        >
          ...
          <Support />
          <a href="https://storyset.com/" className="font-cooper ">All illustrations by Storyset</a>
          </div>
