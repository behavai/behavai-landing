...
//       {/* Content */}
//       <div className="relative z-10 flex flex-col lg:flex-row w-full h-auto lg:h-screen px-6 lg:px-0 py-12 mt-12 gap-12 lg:gap-0">
//         {/* Left Column */}
...
//         {/* Right Column */}
//         <div className="w-full lg:w-3/5 flex flex-col items-center justify-start gap-8 mt-30">
//           {/* <motion.div
//             initial={{ scale: 0.95, opacity: 0 }}
//             animate={{ scale: 1, opacity: 1 }}
//             transition={{ duration: 0.8, ease: "easeOut", delay: 0.6 }}
//             className="w-full max-w-[90%] sm:max-w-[80%] h-[200px] sm:h-[250px] lg:h-[55%] rounded-[18px] bg-[#FAFAFA] shadow-xl border border-gray-200 flex items-center justify-center"
//           >
